...
public final class $YangModuleInfoImpl implements YangModuleInfo {
    ...
    private final String name = "EER";
    private final String namespace = "urn:opendaylight:EER";
    private final String revision = "2013-09-11";
    private final String resourcePath = "/META-INF/yang/EER.yang";
